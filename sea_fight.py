...
class Field(object):
    ...
    def recalculate_weight_map(self, available_ships):
        ...
        # Если там уничтоженый корабль, раненый или клетка с промахом -
        ...
        # и если он помещается прибавляем клетке коэффицент 1.
...
if __name__ == '__main__':
    ...
    # создаем саму игру и начинаем в бесконечном цикле
    game = Game()
    ...
    print('Спасибо вам если доиграли до конца!')
    input('')
